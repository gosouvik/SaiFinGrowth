...
namespace GatiCarRental.Module.Controllers
{
    ...
    public partial class BookingOrderController : ViewController
    {
        ...
        private void PrintAdvanceSlip_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
    ...
    ReportDataProvider.ReportObjectSpaceProvider.CreateObjectSpace(typeof(ReportDataV2));
            ...
            IReportDataV2 reportData =
                ...
                CriteriaOperator.Parse("[DisplayName] = 'Booking Receipt'"));
