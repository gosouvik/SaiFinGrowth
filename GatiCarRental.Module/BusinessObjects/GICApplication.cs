...
namespace GatiCarRental.Module.BusinessObjects
{
    ...
    public class GICApplication : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public GICApplication(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            _GICApplicationID = (Session.Evaluate<GICApplication>(CriteriaOperator.Parse("Max(GICApplicationID)"), CriteriaOperator.Parse("")) == DBNull.Value ? 0 : Convert.ToInt32(Session.Evaluate<GICApplication>(CriteriaOperator.Parse("Max(GICApplicationID)"), CriteriaOperator.Parse("")))) + 1;
        ...
        private void GetDocumentNumbering()
        {
            ...
            docnos.Criteria = CriteriaOperator.Parse("[DocumentType]=?", DocumentType.GICApplication);
            if (docnos.Count == 1)
            {
        ...
        [Persistent("GICApplicationID")] // this line for read-only columns mapping
        private int _GICApplicationID;
        ...
        [Browsable(false)]
        [PersistentAlias("_GICApplicationID")] // This line for read-only column mapping
        public int GICApplicationID
        {
            get { return _GICApplicationID; }
        }

        string fDocumentNo;
        [Appearance("GICApplicationDocNoCond", Enabled = false, Criteria = "IsNew=1", Context = "Any")]
        [RuleUniqueValue]
        [Size(50)]
        ...
        //[RuleRequiredField("RuleRequiredField for GICApplication.AssignTo", DefaultContexts.Save,
        ...
        //[RuleRequiredField("RuleRequiredField for GICApplication.InsuranceCompany", DefaultContexts.Save,
        //"InsuranceCompany must be specified")]
        //[ImmediatePostData]
        //[Association]
        ...
        //        RefreshAvailableGICPlan();
        //    }
        //}

        //private XPCollection<GICPlan> fAvailableGICPlans;
        //[Browsable(false)] // Prohibits showing the AvailableAccessories collection separately
        //public XPCollection<GICPlan> AvailableGICPlans
        //{
        //    get
        //    {
        //        if (fAvailableGICPlans == null)
        //        {
        //            // Retrieve all Sample objects
        //            fAvailableGICPlans = new XPCollection<GICPlan>(Session);
        //            // Filter the retrieved collection according to current conditions
        //            RefreshAvailableGICPlan();
        //        }
        //        // Return the filtered collection of Sample objects
        //        return fAvailableGICPlans;
        //    }
        //}

        //private void RefreshAvailableGICPlan()
        //{
        //    if (fAvailableGICPlans == null)
        //        return;
        ...
        //        fAvailableGICPlans.Criteria = CriteriaOperator.Parse("1=0");
        //    }
        //    else
        //    {
        //        // Leave only the current Party's Collection in the fAvailableSampleCollection collection
        //        fAvailableGICPlans.Criteria = new BinaryOperator("InsuranceCompany", InsuranceCompany);
        ...
        //[DataSourceProperty(nameof(AvailableGICPlans))]
        //[Association]
        //[RuleRequiredField("RuleRequiredField for GICApplication.GICPlan", DefaultContexts.Save, "A Sub Category must be specified")]
        ////[Appearance("PickedCarNumberCond", Enabled = false, Criteria = "Picked", Context = "DetailView")]
        //public GICPlan GICPlan
        //{
        //    get { return fGICPlan; }
        //    set
        //    {
        //        SetPropertyValue(nameof(GICPlan), ref fGICPlan, value);
        ...
        //[Association]
        //[RuleRequiredField("RuleRequiredField for GICApplication.Plan", DefaultContexts.Save, "A Plan must be specified")]
        ////[Appearance("PickedCarNumberCond", Enabled = false, Criteria = "Picked", Context = "DetailView")]
        //public Plan Plan
        //{
        //    get { return fPlan; }
       ...
       // [Browsable(false)]
        ...
        private GICApplicationStatus status;
        public virtual GICApplicationStatus Status
        {
            get { return status; }
            set
            {
                ...
                //if (isLoaded)
                //{
                    if (value == GICApplicationStatus.Closed)
                    {
        ...
        public XPCollection<GICApplicationFileData> Attachments
        {
            get { return GetCollection<GICApplicationFileData>(nameof(Attachments)); }
        }     
               

        Company fCompany;
        //[Browsable(false)]
        [Appearance("CompanyCond", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide, Criteria = "GICApplicationID>0", Context = "Any")]
        ...
        //[Association("MyGICApplication-GICApplicationNotification")]
        //public XPCollection<GICApplicationNotification> MyNotifications
        //{
        //    get
        //    {
        //        return GetCollection<GICApplicationNotification>(nameof(MyNotifications));
        //    }
        //}

        [Action(ImageName = "State_GICApplication_Completed")]
        //[Appearance("REmoveHoldCond", Enabled = false, Criteria = "Status != 0", Context = "Any")]
        public void RemoveHold()
        {
            Status = GICApplicationStatus.PendingApproval;
        }
        
        [Action(ImageName = "State_GICApplication_Approved")]
        public void Approved()
        {
            Status = GICApplicationStatus.Approved;
        }
        [Action(ImageName = "State_GICApplication_Submitted")]
        public void Submitted()
        {
            Status = GICApplicationStatus.Submitted;
        }
        [Action(ImageName = "State_GICApplication_Inprocess")]
        public void Inprocess()
        {
            Status = GICApplicationStatus.Inprocess;
        }
        [Action(ImageName = "State_GICApplication_Rejected")]
        public void Rejected()
        {
            Status = GICApplicationStatus.Rejected;
        }
        [Action(ImageName = "State_GICApplication_Closed")]
        public void Closed()
        {
            Status = GICApplicationStatus.Closed;
        }

        [Action(ImageName = "State_GICApplication_Closed")]
        public void ConvertToPolicy()
        {
            Status = GICApplicationStatus.ConvertToPolicy;
        }
    ...
    public enum GICApplicationStatus
    {
        [ImageName("State_GICApplication_NotStarted")]
        Hold,
        [ImageName("State_GICApplication_PendingApproval")]
        PendingApproval,
        [ImageName("State_GICApplication_Approved")]
        Approved,
        [ImageName("State_GICApplication_Submitted")]
        Submitted,
        [ImageName("State_GICApplication_Rejected")]
        Rejected,
        [ImageName("State_GICApplication_Inprocess")]
        Inprocess,
        [ImageName("State_GICApplication_Closed")]
        Closed,
        ConvertToPolicy
    }
