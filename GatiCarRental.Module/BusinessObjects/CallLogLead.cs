...
namespace GatiCarRental.Module.BusinessObjects
{
    ...
    public class CallLogLead : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public CallLogLead(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            _CallLogLeadID = (Session.Evaluate<CallLogLead>(CriteriaOperator.Parse("Max(CallLogLeadID)"), CriteriaOperator.Parse("")) == DBNull.Value ? 0 : Convert.ToInt32(Session.Evaluate<CallLogLead>(CriteriaOperator.Parse("Max(CallLogLeadID)"), CriteriaOperator.Parse("")))) + 1;
        ...
        private void GetDocumentNumbering()
        {
            ...
            docnos.Criteria = CriteriaOperator.Parse("[DocumentType]=?", DocumentType.CallLogLead);
            if (docnos.Count == 1)
            {
        ...
        [Persistent("CallLogLeadID")] // this line for read-only columns mapping
        private int _CallLogLeadID;
        [RuleUniqueValue] // Validation for unique value
        //[RuleRequiredField("RuleRequiredField for CallLogLead.CallLogLeadID", DefaultContexts.Save,
      //"Call Log Lead ID must be specified")] // Validation for Required
        [Browsable(false)]
        [PersistentAlias("_CallLogLeadID")] // This line for read-only column mapping
        public int CallLogLeadID
        {
            get { return _CallLogLeadID; }
        }

        string fDocumentNo;
        [Appearance("CallLogLeadDocNoCond", Enabled = false, Criteria = "IsNew=1", Context = "Any")]
        [RuleUniqueValue]
        [Size(50)]
        ...
        private Lead fLead;
        [RuleRequiredField("RuleRequiredField for CallLogLead.Leads", DefaultContexts.Save,
        ...
        public Lead Leads
        {
            ...
            set
            {
                SetPropertyValue(nameof(Lead), ref fLead, value);
            }
        }
        ...
        [RuleRequiredField("RuleRequiredField for CallLogLead.Category", DefaultContexts.Save,
        ...
        private void RefreshAvailableResponses()
        {
            ...
            {
                // Leave only the current Party's Collection in the fAvailableSampleCollection collection
                fAvailableResponses.Criteria = CriteriaOperator.Parse("CallLogLead=1 and SubCategory=?", SubCategory);
        ...
        //[Appearance("CallLogleadFollowUpDateTimeCond", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide, Enabled = false, Criteria = "Response != 5", Context = "DetailView")]
        ...
        Company fCompany;
        //[Browsable(false)]
        [Appearance("CompanyCond", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide, Criteria = "CallLogLeadID>0", Context = "Any")]
        ...
        [DevExpress.Xpo.Aggregated, Association("Task-CallLogLeads")]
