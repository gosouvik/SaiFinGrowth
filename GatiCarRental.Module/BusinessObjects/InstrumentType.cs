...
namespace GatiCarRental.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public override void AfterConstruction()
        {
            ...
            _InstrumentTypeID = (Session.Evaluate<InstrumentType>(CriteriaOperator.Parse("Max(InstrumentTypeID)"), CriteriaOperator.Parse("")) == DBNull.Value ? 0 : Convert.ToInt32(Session.Evaluate<InstrumentType>(CriteriaOperator.Parse("Max(InstrumentTypeID)"), CriteriaOperator.Parse("")))) + 1;
        ...
        [Persistent("InstrumentTypeID")] // this line for read-only columns mapping
        private int _InstrumentTypeID;
        ////[RuleRequiredField] // Validation for Required
        [RuleUniqueValue] // Validation for unique value
        [Browsable(false)]
        [PersistentAlias("_InstrumentTypeID")] // This line for read-only column mapping
        ...
        {
            get { return GetCollection<CashBank>(nameof(CashBanks)); }
        }
